...
import { getMessagesBetween, sendMessage, getTeachers, getStudents, getStudentsByClass, getTeacherClasses, getParents, getParentChildren } from "@/lib/api";
...
export default function Messages() {
  ...
  const sendMut = useMutation({
    ...
    onSuccess:()=>{ qc.invalidateQueries({queryKey:["messages",user?.id,selUser?.id]}); setMessage(""); },
